    ...
    <div class="container-fluid">
        <div class="card shadow-sm">
            <div class="card-header bg-transparent border-bottom">
                <div class="row">
                    <div class="col">
                        <h5 class="mt-1 mb-0">Customer Feedback</h5>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <table id="feedbackTable" class="table table-hover table-cs-color">
                </table>
            </div>
        </div>
    </div>
        ...
        <div class="modal-content">
            <form id="brandForm">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="categoryModalLabel">Customer Feedback</h1>
...
<script>
    $(document).ready(function() {
        ...
        var table = $('#feedbackTable').DataTable({
            ...
            autoWidth: false,
            ajax: {
                url: 'process/table.php?table_type=customer-feedback',
                dataSrc: 'data'
            },
            columns: [{
                    data: 'id',
        ...
        function LoadTable() {
            $.ajax({
                url: 'admin/process/table.php?table_type=customer-feedback',
                dataType: 'json',
        ...
        $('#feedbackTable').on('click', 'button.btn-edit', function() {
