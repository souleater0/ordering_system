        ...
        <div class="modal-content">
            <form id="brandForm">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="categoryModalLabel">Menu Details</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body border">
                    <div class="row gy-2">
                        <div class="col-lg-12">
                            <label for="brand_name" class="form-label">Food Name</label>
                            <input type="text" class="form-control" id="brand_name" name="brand_name" placeholder="Ex. Chicken Inasal">
                        </div>
                    </div>
                </div>
...
<script>
    $(document).ready(function() {
        ...
        function LoadTable() {
            $.ajax({
                url: 'admin/process/table.php?table_type=food-menu',
                dataType: 'json',
